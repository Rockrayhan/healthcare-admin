...
<div class="cv-main-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="cv-head-icon">
                        <ul>
                            <li>
                                <a href="./Index-2/cart.html" class="cv-head-cart">
                            ...
                            <li>
                                <a href="/dashboard" class="cv-head-user" data-bs-toggle="modal" data-bs-target="#loginModel">
                        ...
                        <div class="cv-menu">
                            <ul>
                                    ...
                                    <div class="cv-mega-menu">
                                        <div class="cm-menu-list">
                                            <ul>
                                                ...
                                                <li><a href="./index-2/shop.html">N95 masks</a></li>
                                                <li><a href="./index-2/shop.html">Prana air masks</a></li>
                                                <li><a href="./index-2/shop.html">Totobobo masks</a></li>
                                                <li><a href="./index-2/shop.html">Oxiclear masks</a></li>
                                                <li><a href="./index-2/shop.html">Noymi masks</a></li>
                                            </ul>
                                        </div>
                                        <div class="cm-menu-list">
                                            <ul>
                                                ...
                                                <li><a href="./index-2/shop.html">General free size</a></li>
                                                <li><a href="./index-2/shop.html">Disposable kit</a></li>
                                                <li><a href="./index-2/shop.html">Surgical gown</a></li>
                                                <li><a href="./index-2/shop.html">Non woven kit</a></li>
                                                <li><a href="./index-2/shop.html">Pp spun bond</a></li>
                                            </ul>
                                        </div>
                                        <div class="cm-menu-list">
                                            <ul>
                                                ...
                                                <li><a href="./index-2/shop.html">Nonwoven laminated</a></li>
                                                <li><a href="./index-2/shop.html">100 gsm disposable</a></li>
                                                <li><a href="./index-2/shop.html">Polypropylene 90 GSM</a></li>
                                                <li><a href="./index-2/shop.html">Disposable</a></li>
                                                <li><a href="./index-2/shop.html">Body coveralls</a></li>
                                            </ul>
                                        </div>
                                        <div class="cm-menu-list">
                                            <ul>
                                                ...
                                                <li><a href="./index-2/shop.html">safety goggles</a></li>
                                                <li><a href="./index-2/shop.html">Zoom goggles</a></li>
                                                <li><a href="./index-2/shop.html">Sleeping masks</a></li>
                                                <li><a href="./index-2/shop.html">Eye lense</a></li>
                                                <li><a href="./index-2/shop.html">Eye protector</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="cv-children-menu"><a href="javascript:;">Pages</a>
                                    <ul class="cv-sub-mmenu">
                                        <li><a href="./index-2/blog-single.html">Blog single</a></li>
                                        <li><a href="./index-2/product-single.html">Product single</a></li>
                                        <li><a href="./index-2/account.html">My account</a></li>
                                        <li><a href="./index-2/cart.html">Cart</a></li>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="cv-banner-text">
                        <p class="cv-banner-cat">Medical personal protective equipment PPE </p>
                ...
                <div class="col-md-6">
                    <div class="cv-banner-img">
                        <img src="https://kamleshyadav.com/html/medical-equipments/html/assets/images/banner.png" alt="images" class="img-fluid"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="cv-arrival spacer-top-less">
        <div class="container">
            ...
            <div class="row">
                @php
                $products = $product->take(4); // get first four only
                @endphp
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="cv-testi-box">
                                ...
                                <div class="cv-testi-footer">
                                    <div class="cv-testi-img">
                                        <img src="https://kamleshyadav.com/html/medical-equipments/html/assets/images/user.jpg" alt="image" class="img-fluid"/>
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="cv-testi-box">
                                ...
                                <div class="cv-testi-footer">
                                    <div class="cv-testi-img">
                                        <img src="https://kamleshyadav.com/html/medical-equipments/html/assets/images/user2.jpg" alt="image" class="img-fluid"/>
                                    </div>
                                    <div class="cv-testi-name">
                                        <h1>John Michel</h1>
                                        <p>Manager</p>
    ...
    <!-- blog start -->
     ...
     <div class="cv-blog spacer-top-less">
        <div class="container">
            <div class="cv-heading">
                <h1>Latest update</h1>
                <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="cv-blog-box">
                        <div class="cv-blog-img">
                            <img src="https://kamleshyadav.com/html/medical-equipments/html/assets/images/blog3.jpg" alt="image" class="img-fluid"/>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cv-blog-box">
                        <div class="cv-blog-img">
                            <img src="https://kamleshyadav.com/html/medical-equipments/html/assets/images/blog4.jpg" alt="image" class="img-fluid"/>
                        </div>
                        <div class="cv-blog-data">
                            <a href="javascript:;" class="cv-blog-date">25 May 2020</a>
                            <a href="blog-single.html" class="cv-blog-title">Quis nostrud exercitation ullamco</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="cv-blog-box">
                        <div class="cv-blog-img">
                            <img src="https://kamleshyadav.com/html/medical-equipments/html/assets/images/blog6.jpg" alt="image" class="img-fluid"/>
                        </div>
                        <div class="cv-blog-data">
                            <a href="javascript:;" class="cv-blog-date">25 May 2020</a>
                            <a href="blog-single.html" class="cv-blog-title">Quis nostrud exercitation ullamco</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6">
                    <div class="cv-foot-box cv-foot-links">
                        <h2>Categories</h2>
                        <ul>
                            <li><a href="javascript">Face masks</a></li>
                            <li><a href="javascript">PPE Kit</a></li>
                            <li><a href="javascript">Safety suits</a></li>
                            <li><a href="javascript">Eye protector</a></li>
                            <li><a href="javascript">Disposable</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-2 col-md-6">
                    <div class="cv-foot-box cv-foot-links">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript">Statements</a></li>
    ...
    <div class="cv-copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>&copy; 2022. All right reserverd by Medical Equipments</p>
                </div>
            </div>
        </div>
    </div>
